...
if ((RANDOM%2)); then echo "${names[RANDOM%${#names[@]}]}'s-$d"; else echo "$d"; fi
;;
1)
if ((RANDOM%2)); then echo "DESKTOP-$(r 7)"; else echo "LAPTOP-$(r 7)"; fi
;;
3)
...
sudo hostnamectl set-hostname "$(randname)" --static
